...
class Car(db.Model):
    ...
    Condition_ID = db.Column(db.Integer, db.ForeignKey("Car_condition.Condition_ID"), nullable=False)
    Dealer_ID = db.Column(db.Integer, db.ForeignKey("Car_dealer.Car_dealer_ID"), nullable=False)
...
class Transaction(db.Model):
    ...
    Employee_ID = db.Column(db.Integer, db.ForeignKey("Employee.Employee_ID"), nullable=False)
    Transaction_type_ID = db.Column(db.Integer, db.ForeignKey("Transaction_type.Transaction_type_ID"), nullable=False)
